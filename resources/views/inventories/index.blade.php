       ...
       function renderTable(items) {
          ...
          try {
              ...
              items.forEach(item => {
                 ...
                 row.innerHTML = `
                     <td class="py-3.5 pr-4 pl-4 text-neutral-500 font-harmonia">${item.name || 'N/A'}</td>
                     ...
                     <td class="py-3.5 pr-2 text-neutral-600 dark:text-neutral-300 font-harmonia">₱${(item.rental_price || 0).toLocaleString()}</td>
